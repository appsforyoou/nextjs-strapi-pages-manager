...
import { PageSearchData } from '../types/next';
...
export default async function mapSections({ getComponent, getSection, lang, pageSlug, searchData }: Props): Promise<RType> {
    ...
    for (const sectionData of dbSections) {
        ...
        sectionData.searchData = searchData;
